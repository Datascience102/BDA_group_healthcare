...
```{r} 
library(ggplot2)
Activity_order <- matrix(c("Consultation","Imaging diagnostics","Inpatient_surg","Outpatient_surg", "Nursing_days","Outpatient_admissions",2,3,5,4,1,6),nrow=6,ncol=2)
...
ggplot(Result_graph_ordered, aes(x=Year,y=Space_x1000m2,group=Number,fill=Number)) + geom_area(stat="identity") + geom_line(position='stack') + labs(title="Needed space per category in m2")
