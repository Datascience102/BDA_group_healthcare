...
Total_activities_2014$Year=2014 #  add column to label the data as Year 2014
...
Projection <- merge(Pop_index, Total_activities_2014,  by.x=c("Age_gender_ID","Year"), by.y=c("Age_gender_ID", "Year"),select=c("Year","Region", "Population_x1000", "Act_per_1000inhab","Space_per_act"))
