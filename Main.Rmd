...
Surgeries$Total_surgeries<-as.numeric(Surgeries$Total_surgeries)
Surgeries$Total_surgeries_per_10000_inhabitants<-as.numeric(Surgeries$Total_surgeries_per_10000_inhabitants)
Surgeries$Inpatient_surgeries<-as.numeric(Surgeries$Inpatient_surgeries)
Surgeries$Inpatient_surgeries_per_10000_inhabitants<-as.numeric(Surgeries$Inpatient_surgeries_per_10000_inhabitants)
Surgeries$Outpatient_surgeries<-as.numeric(Surgeries$Outpatient_surgeries)
Surgeries$Outpatient_surgeries_per_10000_inhabitants<-as.numeric(Surgeries$Outpatient_surgeries_per_10000_inhabitants)
...
Admissions$Total_admissions_per_10000_inhabitants[Admissions$Total_admissions_per_10000_inhabitants=="."]<-0
Admissions$Outpatient_admissions_per_10000_inhabitants[Admissions$Outpatient_admissions_per_10000_inhabitants=="."]<-0
Admissions$Inpatient_admissions_per_10000_inhabitants[Admissions$Inpatient_admissions_per_10000_inhabitants=="."]<-0
Admissions$Average_nursing_days_per_inpatient_admission[Admissions$Average_nursing_days_per_inpatient_admission=="."]<-0
Admissions$Average_poulation[Admissions$Average_poulation=="."]<-0


Admissions$Total_admissions_per_10000_inhabitants<-as.numeric(Admissions$Total_admissions_per_10000_inhabitants)
Admissions$Outpatient_admissions_per_10000_inhabitants<-as.numeric(Admissions$Outpatient_admissions_per_10000_inhabitants)
Admissions$Inpatient_admissions_per_10000_inhabitants<-as.numeric(Admissions$Inpatient_admissions_per_10000_inhabitants)
Admissions$Nursingdays_per_10000_inhabitants<-as.numeric(Admissions$Nursingdays_per_10000_inhabitants)
Admissions$Average_nursing_days_per_inpatient_admission<-as.numeric(Admissions$Average_nursing_days_per_inpatient_admission)
Admissions$Average_poulation<-as.numeric(Admissions$Average_poulation)
...
summary_table[which(summary_table$Type_act == "Outpatient_admissions"),"Number_act_source2"] <- sum(subset(Admissions, Year == "2010", select="Outpatient_admissions_total"))

summary_table[which(summary_table$Type_act == "Nursing_days"),"Number_act_source2"] <- sum(subset(Admissions, Year == "2010", select="Nursingdays_total"))
...
head(Surgeries_def_inp,5)
head(Surgeries_def_outp,5)
```
...
head(Admissions_def_inp,5)
head(Admissions_def_outp,5)
```
...
Total_activities_2014 <- rbind.fill(Admissions_def_outp,Surgeries_def, Imaging_def, Consultation_def, Admissions_def_inp)
...
ggplot(Result_graph, aes(x=Year,y=Space_x1000m2,group=Activity,fill=Activity)) + geom_area() + geom_line(position='stack')
Result_graph2 <- data.frame(subset(Result_graph, (Year==2015|Year==2020| Year==2025|Year==2030|Year==2035|Year==2040),select=c("Year","Activity","Space_x1000m2"), drop=TRUE))
